...
import serviceImg1 from "../../image/daging-sapi.jpg";
import serviceImg2 from "../../image/daging-kerbau.jpg";
        ...
        <div className="row">
          <div className="col-md-12 mx-auto">
            <div className="row">
              <div className="col-md-12">
                <div className="site-heading text-center">
                  <h3 className="sub-title">PRODUK DAGING</h3>
                </div>
              </div>
            </div>
            ...
            <div className="row justify-content-center">
                ...
                <div className="col-md-4  col-sm-6">
                    <div className="project-box">
                    <Link to="/products-daging-kerbau">
